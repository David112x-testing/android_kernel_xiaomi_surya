...
if [[ $1 = "-t" || $1 = "--tools" ]]; then
	...
	git clone -b 12.0.0 https://gitlab.com/David112x/sdclang $HOME/tc/clang --depth=1
	touch $HOME/tc/sdclang/AndroidVersion.txt && echo -e "15" | sudo tee -a $HOME/tc/sdclang/AndroidVersion.txt > /dev/null 2>&1
fi
